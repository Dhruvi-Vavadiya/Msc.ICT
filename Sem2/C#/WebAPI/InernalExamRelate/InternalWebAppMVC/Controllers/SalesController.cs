...
using InternalWebAppMVC.Models;

namespace InternalWebAppMVC.Controllers
{
    public class SalesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SaleId,ProductId,Date,Discount,BasePrice")] Sale sale)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    var result = await _client.GetAsync($"{baseURL}/{sale.BasePrice}/{sale.Discount}");
